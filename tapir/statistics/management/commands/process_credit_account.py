...
from tapir.statistics.models import ProcessedPurchaseFiles, CreditAccount
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        # ]:
        self.process_file(
            sftp_client.open(files_on_server.first()), files_on_server.first()
        )
    ...
    def process_file(cls, file: SFTPFile, file_name: str):
        ...
        for row in csv.DictReader(file, delimiter=",", quotechar='"'):
            ...
            CreditAccount.objects.create(
                ...
                credit_amount=cls.parse_german_number(row["Credit"]),
